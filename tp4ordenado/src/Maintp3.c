...
int main()
{
    ...
    do{
        ...
        switch(option)
        {
            case 1:
            	if(flagAbm==1){
            		printRecuadro(" #Atencion# si carga el texto sin antes guardar se perderan los datos cargados hasta el momento\n ");
                ...
                if(controller_loadFromText("data.csv",listaEmpleados)){
                	printRecuadro("Carga de Archivo en modo texto finalizado con exito\n");
                	flagCarga=1;
                }else{
                	printRecuadro("#Error al cargar el archivo en modo texto verifique\n");
                }
            	}else{
            		system("pause");
            	}
            ...
            case 2:
            	...
            	if(controller_loadFromBinary("data.bin", listaEmpleados)){
            		printRecuadro("Carga de Archivo en modo binario finalizado con exito\n");
            		flagCarga=1;
            	}else{
            		printRecuadro("#Error al cargar el archivo en modo binario verifique\n");
            	}
            ...
            case 8:
            	...
            	if(flagAbm==1 && flagCarga==1){
            		if(controller_saveAsText("data.csv",listaEmpleados)){
            	            		printRecuadro("Guardado (modo texto) Exitoso\n");
            	            	}else{
            ...
            case 9:
            	...
            	if(controller_saveAsBinary("data.bin", listaEmpleados)){
            		printRecuadro("Guardado (modo Binario) Exitoso\n");
            	}else{
            		printRecuadro("#Error,al guardar,verifique\n");
            	}
            	}
            	...
            	if(flagAbm==1 && flagCarga!=1){
            		if(controller_saveAsText("ABMbinario.bin",listaEmpleados)){
            		            		printRecuadro("Guardado (modo texto) Exitoso guardado en ABMbinario.bin \n");
            		            	}else{
            		            		printRecuadro("#Error,al guardar,verifique\n");
            		            	}
            		            	}
            	break;
            case 10:
            	controller_aumentaSueldo(listaEmpleados);
            	break;
        }
    }while(option != 11);
